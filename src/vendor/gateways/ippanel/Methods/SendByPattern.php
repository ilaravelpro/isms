...
trait SendByPattern
{
    public static function sendByPattern(SMSMessage $model, $names, $sender = null)
    {
        return (new self($sender))->_sendByPattern(...func_get_args());
    }

    public static function sendByPatternFast($type,$pattern, $names, $receiver, $message, $sender = null)
    {
        return (new self($sender))->_sendByPatternFast(...func_get_args());
    }
